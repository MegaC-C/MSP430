...
int main(void)
{
	...
	// 2.configure CCRx
	TA0CCTL1 |= CAP | CM__BOTH | CCIS__GND;	// CCR1 in capture mode, sensitive 
											// 
	// 
	// 
	// to switching to VCC and GND,
	// select GND as initial input
	// signal
